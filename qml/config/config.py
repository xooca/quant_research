...
class Config:
    def __init__(self,master_config_path,master_config_name='master_config'):
...
class DefineConfig(Config):
    def __init__(self,master_config_path,master_config_name):
        Config.__init__(self,master_config_path,master_config_name)
