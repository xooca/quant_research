...
def rolltrends(close, length=None, offset=None, **kwargs):
...
def rolltrends_method(self, length=None, offset=None, **kwargs):
    close = self._get_column(kwargs.pop("close", "close"))
    result = rolltrends(close=close, length=length, offset=offset, **kwargs)
