...
def rolllb(close, length=None, offset=None, **kwargs):
...
def rolllb_method(self, length=None, offset=None, **kwargs):
    close = self._get_column(kwargs.pop("close", "close"))
    result = rolllb(close=close, length=length, offset=offset, **kwargs)
