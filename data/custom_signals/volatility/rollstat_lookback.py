...
def rollstat_lookback(close, length=None, offset=None, **kwargs):
...
def rollstat_lookback_method(self, length=None, offset=None, **kwargs):
    close = self._get_column(kwargs.pop("close", "close"))
    result = rollstat_lookback(close=close, length=length, offset=offset, **kwargs)
